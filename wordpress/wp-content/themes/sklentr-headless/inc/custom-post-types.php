...
add_action('init', function () {
    register_post_type('gallery', [
        'labels' => [
            'name'               => __('Galleries', 'sklentr-headless'),
            'singular_name'      => __('Gallery', 'sklentr-headless'),
            'add_new'            => __('Add New Gallery', 'sklentr-headless'),
            'add_new_item'       => __('Add New Gallery', 'sklentr-headless'),
            'edit_item'          => __('Edit Gallery', 'sklentr-headless'),
            'all_items'          => __('All Galleries', 'sklentr-headless'),
            'search_items'       => __('Search Galleries', 'sklentr-headless'),
            'not_found'          => __('No galleries found', 'sklentr-headless'),
        ],
        'public'             => true,
        'has_archive'        => true,
